  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 pb-16">
      ...
      {requirement.quotationId && (
        <div className="bg-linear-to-r from-emerald-50 via-teal-50 to-white border border-emerald-300 rounded-xl p-5 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 text-[11px] font-semibold bg-white text-emerald-800 rounded border border-emerald-300">
                  {requirement.quotationTitle || requirement.title}
                </span>
                <span className="font-mono text-[10px] text-emerald-700">Ref: {requirement.quotationId}</span>
              </div>
