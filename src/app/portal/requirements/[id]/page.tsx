...
export default function CustomerRequirementDetailPage() {
  ...
  const { data: req, isLoading, isError, refetch } = useRequirement(reqId, ready);
  const { data: quotations = [] } = useQuotations(ready);
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-16">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Reference: <strong className="font-mono">{req.id}</strong> • Organization: <strong>{req.customerName}</strong> • Submitted:{' '}
      ...
      {req.quotationId && (
        <Card className="bg-linear-to-r from-emerald-50 via-teal-50 to-white border-teal-300 shadow-enterprise p-5">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-slate-900">
                    Quote: {req.quotationTitle || 'Quotation'}
                  </span>
                </div>
            ...
            <CardContent className="p-4 space-y-4 text-xs">
              ...
              {req.additionalNotes && (
                <div>
                  ...
                  <p className="leading-relaxed bg-amber-50/50 p-3 rounded border border-amber-200/70 text-amber-950">
                    {req.additionalNotes}
                  </p>
                </div>
              )}
