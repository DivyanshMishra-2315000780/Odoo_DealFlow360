  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (description.trim().length < 10) {
      toast({
        ...
        description: 'Please provide at least 10 characters describing the requirement.',
        type: 'error',
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: err instanceof Error ? err.message : 'Unable to commit requirement. Please try again.',
        type: 'error',
      });
    }
  };
