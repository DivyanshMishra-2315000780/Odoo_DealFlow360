...
export async function getQuote(id: string) {
  ...
  if (!['PENDING_APPROVAL','SENT','UNDER_NEGOTIATION','FULFILLMENT','BILLING','COMPLETED'].includes(quote.status) && !(quote.reapprovalRequired)) throw new AuthorizationError('Quotation is not yet shared with the customer');
