...
export function useFulfillmentOrders(enabled = true) {
  return useQuery({
...
export function useRequirements(customerId?: string, enabled = true) {
  return useQuery({
...
export function useRequirement(id: string, enabled = true) {
  return useQuery({
